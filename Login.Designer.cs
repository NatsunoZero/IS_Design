namespace Visualization
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button1.Text = "登录(&O)";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			this.button1.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Shift_KeyDown);
			this.button1.KeyUp += new System.Windows.Forms.KeyEventHandler(this.Shift_KeyUP);
			// 
			// button2
			// 
			...
			this.comboBox1.SelectedIndexChanged += new System.EventHandler(this.cboLgoinName_SelectedIndexChanged);
			this.comboBox1.KeyDown += new System.Windows.Forms.KeyEventHandler(this.textBox1_KeyDown);
			// 
			// chkMemoryPwd
			// 
			this.chkMemoryPwd.AutoSize = true;
			this.chkMemoryPwd.Location = new System.Drawing.Point(55, 151);
			this.chkMemoryPwd.Name = "chkMemoryPwd";
			this.chkMemoryPwd.Size = new System.Drawing.Size(72, 16);
			this.chkMemoryPwd.TabIndex = 2;
